**@fest-lib/ssre API Documentation v0.1.17**

***

# ssr.e

Backend-first sibling of [LUR.E](https://github.com/fest-live/lur.e). Same `H` / `E` / `M` ideas and `object.ts` refs, but it renders **HTML on the server** with a scripted reactive scenario — no DOM, overlays, drag, or other client-only LUR.E features.
